                ...
                }
                {
                    ...
                    a:{
                        fn:{
                              ...
                              const ev = _.E_I_V('phonenumber');
                                if(ev && ev !== null && ev !== '' ){
                                      if(_.IS_PHONE_NUMBER(ev)){
                                             ...
                                             const callback = (res)=>{
                                                        ...
                                                        if(res){
                                                            ...
                                                            _.E_I_S('phonenumberCallback').innerHTML = "Phone Number exist";
                                                            _.E_I_S('phonenumberCallback').innerHTML = "";

                                                            const accept = {c:'WW',e:[{t:'p',s:'Phone Number exist',c:'F_RE4  F_S_10 D_INB'},{t:'icon',c:'ICO-ui-close F_RE4 _MR_5'}]};
                                                            _.CR_(accept,'phonenumberCallback',false);
                                                            ...
                                                            const accept = {c:'WW',e:[{t:'p',s:'Valid Phone Number ',c:'F_GRE4  F_S_10 D_INB'},{t:'icon',c:'ICO-ui-check F_GRE4 _MR_5'}]};
                                                            _.CR_(accept,'phonenumberCallback',false);
                                                            _.A_CL('phonenumber-input-holder','D_N');
                                                            _.D_CL('signFormHolder','D_N');
                                                        }
                                         ...
                                         _.E_I_S('phonenumberCallback').innerHTML = "please insert valid Phone Number ";
                                        _.E_I_S('phonenumberCallback').innerHTML = "";
                                        const accept = {c:'WW',e:[{t:'p',s:'please insert valid Phone Number ',c:'F_RE4  F_S_10 D_INB'},{t:'icon',c:'ICO-ui-close F_RE4 _MR_5'}]};
                                        _.CR_(accept,'phonenumberCallback',false);
                                      }
