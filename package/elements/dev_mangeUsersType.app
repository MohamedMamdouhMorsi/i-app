                                ...
                                e:[
                                    {
                                        ...
                                        a:{
                                            fn:{
                                                if(Q.id){
                                                    const usersTypeName = _.E_I_V(`input_usersType_typeName_${Q.id}`);
                                                    const usersTypeDescription = _.E_I_V(`input_usersType_description_${Q.id}`);
                                                    ...
                                                    _._POST('/api',{_IQuery_:[
                                                        {
                                                            ...
                                                            d:[[2,usersTypeName],[3,usersTypeDescription]]
                                                        }
                                                    ]});
                                                }
                                            }
